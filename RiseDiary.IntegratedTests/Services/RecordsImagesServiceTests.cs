...
{
    private static async Task<(Guid recId, Guid imgId, IRecordsImagesService recImgSvc, IImagesService imgSvc, DiaryDbContext context)> CreateRecordWithLinkedImage()
    {
