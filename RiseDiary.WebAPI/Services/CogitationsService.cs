...
public class CogitationsService : ICogitationsService
{
    ...
    public async Task<Guid> AddCogitation(Guid recordId, string cogitationText)
    {
        ...
        var cogitation = new RecordCommentEntity
        {
            Id = Guid.NewGuid(),
            RecordId = recordId,
    ...
    public async Task<List<RecordCommentEntity>> GetRecordCogitations(Guid recordId, CancellationToken cancellationToken)
    {
