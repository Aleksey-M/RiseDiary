...
namespace RiseDiary.WebUI.Pages.Settings
{
    public class PageSizeModel : PageModel
    {
        ...
        public async Task OnPostUpdateImagesPageSizeAsync(int imagesPageSize)
        {
            ...
            {
                await _appSettingsService.UpdateAppSetting(AppSettingsKey.ImagesPageSize, $"{imagesPageSize}").ConfigureAwait(false);
            }
        ...
        public async Task OnPostUpdateRecordsPageSizeAsync(int recordsPageSize)
        {
            ...
            {
                await _appSettingsService.UpdateAppSetting(AppSettingsKey.RecordsPageSize, $"{recordsPageSize}").ConfigureAwait(false);
            }
