...
namespace RiseDiary.WebUI.Migrations
{
    ...
    [Migration("20190103212811_AddedNavigationPropertiesToAllEntities")]
    partial class AddedNavigationPropertiesToAllEntities
    {
            ...
            modelBuilder.Entity("RiseDiary.Model.DiaryImageFull", b =>
                {
                    b.HasOne("RiseDiary.Model.DiaryImage", "DiaryImage")
                        .WithOne("FullImage")
                        .HasForeignKey("RiseDiary.Model.DiaryImageFull", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
